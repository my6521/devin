...
using Devin.ResponseWrapper.Filters;
...
namespace Devin.ResponseWrapper.Providers
{
    public class ResponseWrapperApplicationModelProvider : IApplicationModelProvider
    {
        ...
        private readonly IApiResult<object?> _genericResponseWrapper;
        ...
        public ResponseWrapperApplicationModelProvider(IOptions<ResponseWrapperOptions> responseWrapperOptions, ILoggerFactory loggerFactory)
        {
        ...
        public void OnProvidersExecuting(ApplicationModelProviderContext context)
        {
            ...
            foreach (var controllerModel in context.Result.Controllers)
            {
                ...
                if (controllerModel.Attributes.OfType<DisableResponseWrapperAttribute>().Any())
                {
                ...
                foreach (var actionModel in controllerModel.Actions)
                {
                    ...
                    if (actionModel.Attributes.OfType<DisableResponseWrapperAttribute>().Any()) continue;
                    actionModel.Filters.Add(new ActionResultWrapperFilter(_responseWrapper, _genericResponseWrapper));
